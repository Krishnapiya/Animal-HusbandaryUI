...
return (
<>
<Table stickyHeader sx={{ minWidth: 650 }}> <TableHead> <TableRow>
{props.tableColumns.map((col, index) => ( <TableCell key={index}>
<TableSortLabel
...
>
{col.header} </TableSortLabel> </TableCell>
))}
{props.canEdit ? <TableCell>Edit</TableCell> : null}
{props.canDelete ? <TableCell>Delete</TableCell> : null} </TableRow> </TableHead>
